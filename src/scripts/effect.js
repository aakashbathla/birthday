...
$("document").ready(function () {
  ...
  $("#invite_friends").click(function () {
    ...
    $("#f9").animate({ top: mid + mid_diff * 2, left: vw + vw_diff * 8 }, 3000);
  ...
  $("#dj_time").click(function () {
    ...
    setTimeout(() => {
      $("body").addClass("peach-disco-rotate");
      $("#f1").addClass("dance-one-rotate");
      $("#f3").addClass("dance-two-rotate");
      $("#f2").addClass("dance-one-rotate");
      $("#f4").addClass("dance-two-rotate");
      $("#f5").addClass("dance-one-rotate");
      $("#f6").addClass("dance-one-rotate");
      $("#f7").addClass("dance-two-rotate");
      $("#f8").addClass("dance-two-rotate");
      $("#self").addClass("dance-one-rotate");
      $("#f9").addClass("dance-one-rotate");
    }, 5000);
